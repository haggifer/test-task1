...
import { Box, Pagination, TextField, Typography, useMediaQuery, useTheme } from "@mui/material";
import { useAppDispatch, useAppSelector } from "../../../redux/hooks";
import { selectPokemonList, selectPokemonTypes } from "../../../redux/selectors/pokemon";
...
export default function PokemonList(): ReactElement {
  ...
  const [lastURLParamsObject, setLastURLParamsObject] = useState<IPokemonListParams>(defaultURLParamsObject)

  const [isLoading, setIsLoading] = useState<boolean>(false)

  const [perPageOptions] = useState<ISelectOption<number>[]>(generatePerPageOptions([12, 24, 48]))
          ...
          <>
            ...
            <Box className={classes.list_pagination}>
              ...
              <Pagination
                ...
                page={offset ? Math.round(offset / values.limit.value + 1) : offset + 1}
